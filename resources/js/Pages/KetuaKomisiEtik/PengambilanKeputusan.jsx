    ...
    return (
        <div className="flex min-h-screen bg-gray-50 text-gray-800">
            ...
            <div className="flex-1 ml-64 min-h-screen flex flex-col">
                <Head title="Pengambilan Keputusan Akhir" />
                        ...
                        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                            ...
                            {selected && (
                                <div className="lg:col-span-2 space-y-6">
                                    ...
                                    {/* Reviews Summary */}
                                    <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-6">
                                        <h4 className="font-semibold text-gray-900 mb-4">Ringkasan Review dari Reviewer</h4>
                                            ...
                                            <div className="space-y-3">
                                                {selected.reviews.map((review, idx) => (
                                                    <div key={idx} className="border border-gray-200 rounded-xl p-4 bg-gray-50 hover:bg-gray-100 transition">
                                                        ...
                                                        {review.feedback && (
                                                            <p className="text-sm text-gray-700 italic border-t border-gray-200 pt-3 mt-3">
                                    ...
                                    <form onSubmit={(e) => handleDecision(e, selected.id)} className="bg-white rounded-2xl border border-gray-100 shadow-sm p-6 space-y-4">
                                            ...
                                            >
                                                ...
                                                <div className="flex items-center gap-3 flex-1">
                                                    ...
                                                    <div>
                                                        ...
                                                        <p className="text-xs text-gray-600">Proposal layak etik dan mendapat sertifikat</p>
                                                    </div>
                                                </div>
                                            </label>
                                        ...
                                        <div>
                                            ...
                                            <textarea
                                                ...
                                                rows="5"
                                                className="w-full border border-gray-300 rounded-xl p-4 text-sm focus:ring-2 focus:ring-green-500 focus:border-transparent"
                                                placeholder="Jelaskan alasan keputusan akhir Anda sebagai Ketua Komisi Etik..."
                                                required
                                            />
                                        </div>
